...
namespace Task_4
{
    ...
    class Program
    {
        ...
        {
            int number = 1;
            ProductString ps1 = new ProductString(037654, "Хлеб зерновой", 50.00, 1);
            ProductString ps2 = new ProductString(037000, "Халва Дружба", 100.00, 1);
            string topInfo = "Название магазина";
            string bottomInfo = "Тел. горячей линии: + 7 777 777 77 77";

            Console.WriteLine($"***** {topInfo} *****");
            Console.WriteLine();
            Console.WriteLine($"{number} {ps1.Id} {ps1.Name} {ps1.Price} {ps1.Quantity}");
            Console.WriteLine($"{number} {ps2.Id} {ps2.Name} {ps2.Price} {ps2.Quantity}");
            Console.WriteLine();
            Console.WriteLine($"***** {bottomInfo} *****");
            Console.ReadLine();
        }
    }
}
